				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?php echo base_url();?>index.php/"><img src="<?php echo base_url()?>assets/front/images/home/logo.png" alt="" /></a>
						</div>
							...
							<ul class="nav navbar-nav">
								...
								<?php $shipping_id = $this->session->userdata('shipping_id');?>
									...
									<?php if($this->cart->total_items()!=Null && $customer_id!=NULL && $shipping_id!=NULL){
										?>
								<li>
									<a href="<?php echo base_url();?>index.php/payment"><i class="fa fa-crosshairs"></i> Checkout</a>

								</li>
									<?php }elseif($this->cart->total_items()!=Null && $customer_id!=NULL){?>

								<li>
									<a href="<?php echo base_url();?>index.php/billing"><i class="fa fa-crosshairs"></i> Checkout</a>

								</li>

									<?php }else{?>
								<li>
									<a href="<?php echo base_url();?>index.php/checkout"><i class="fa fa-crosshairs"></i> Checkout</a>

								</li>
									<?php } ?>
								<li>
									<?php if($this->cart->total_items()!=Null && $customer_id!=NULL && $shipping_id!=NULL){?>
									<a href="<?php echo base_url();?>index.php/payment"><i class="fa fa-credit-card"></i>Payment</a>
									<?php } ?>
								</li>
								<li>	
									<a href="<?php echo base_url();?>index.php/show-cart"><i class="fa fa-shopping-cart"></i>
								...
								if($customer_id){?>
								<li>
									<a href="<?php echo base_url();?>index.php/logout"><i class="fa fa-lock"></i> Logout</a>
								</li>
								<?php }else{ ?>
								<li>
									<a href="<?php echo base_url();?>index.php/checkout"><i class="fa fa-lock"></i> Login</a>
								</li>
								<?php } ?>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
									...
									<ul role="menu" class="sub-menu">
										<li><a href="<?php echo base_url();?>index.php/products">Products</a></li>
											<?php if($this->cart->total_items()!=Null && $customer_id!=NULL){
													?>
											<li>
												<a href="<?php echo base_url();?>index.php/billing">Checkout</a>
											...
											<li>
												...
												<?php } ?>
											<li>	
												<a href="<?php echo base_url();?>index.php/show-cart">
												<?php $cart_items =  $this->cart->total_items();
													if($cart_items>0){
												?> 
												 Cart(<?php echo $cart_items;?>)
								...
								<li><a href="<?php echo base_url();?>index.php/home/_404_page">404</a></li>
...
<?php } ?>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2017 SHOP ONLINE Inc. All rights reserved.</p>
