						...
						<ul>
							<?php foreach ($all_sub_category as  $subcat) {?>
								<?php if($subcat->category_sub_id == $maincat->category_id){?>
										<li><a href="<?php echo base_url();?>index.php//show-post-by-sub-cat-id/<?php echo $subcat->sub_cat_id?>"><?php echo $subcat->sub_category_name?></a></li>
								<?php }?>
							<?php } ?>						
						</ul>
					</div>
		...
		<div class="brands_products"><!--brands_products-->
			...
			<div class="brands-name">
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="<?php echo base_url();?>index.php/show-post-by-brand-id/<?php echo $brand->brand_id?>"> <span class="pull-right">
						<?php
