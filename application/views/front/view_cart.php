					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="<?php echo base_url();?>index.php/delete-to-cart/<?php echo $items['rowid']?>"><i class="fa fa-times"></i></a>
							</td>
						</tr>
						<?php } ?>
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<a class="btn btn-default check_out" href="<?php echo base_url();?>index.php/payment">Check Out</a>
							<?php } elseif($customer_id!=NULL && $this->cart->total_items()!=Null){?>
							<a class="btn btn-default check_out" href="<?php echo base_url();?>index.php/billing">Check Out</a>
