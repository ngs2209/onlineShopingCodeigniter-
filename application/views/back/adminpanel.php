...
<head>
    ...
    <title>Online Shopping | Admin Dashboad</title>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <a class="text-center" href="<?php echo base_url();?>index.php/contact-message-list">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url();?>index.php/Login/adminlogout"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                        </li>
                    </ul>
                    <!-- end dropdown-user -->
                </li>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>index.php/register-form"><i class="fa fa-user-plus fa-fw"></i>Register User</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-tags fa-fw"></i> Category Option<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>index.php/add-category"><i class=""></i>Add Category</a>
                             </li>
                             <li>
                                 <a href="<?php echo base_url();?>index.php/add-sub-category"><i class=""></i>Add Sub Category</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>index.php/category-list"><i class=""></i>Category List</a>
                            </li>
                            <li>
                                 <a href="<?php echo base_url();?>index.php/sub-category-list"><i class=""></i>Sub Category List</a>
                            </li>
                        </ul>
                    </li>
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>index.php/add-product"><i class=""></i>Add Product</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>index.php/product-list"><i class=""></i>Product List</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>index.php/add-brand">Add Brand</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>index.php/brand-list">Brand List</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        <a href="<?php echo base_url();?>index.php/manage-order"><i class="fa fa-flask fa-fw"></i>Manage Order</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
