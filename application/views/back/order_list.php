                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeC">
                                   ...
                                   <td>
                                        <a class="btn btn-info" href="<?php echo base_url();?>index.php/view-order/<?php echo $value->order_id?>">View</a>
                                        <a class="btn btn-warning" href="">Edit</a>
                                        <a onclick="alert('Are Your Sure to Delete')" class="btn btn-info" href="<?php echo base_url();?>index.php/delete-order/<?php echo $value->order_id?>">Delete</a>
