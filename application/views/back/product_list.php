                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeC">
                                   ...
                                   <td>
                                        <a class="btn btn-info" href="<?php echo base_url();?>index.php/edit-product/<?php echo $value->pro_id?>">Edit</a>
                                        <a class="btn btn-danger" href="<?php echo base_url();?>index.php/delete-product/<?php echo $value->pro_id?>">Delete</a>
                                    </td> 
