...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2020 at 01:37 PM
...
create database `ecommerce_codeigniter`;
use `ecommerce_codeigniter`;
--
...
(49, 'Sankar', 'admin@admin.com', 'e6e061838856bf47e1de730719fb2609', '9876543210', 'kinathukadavu', 'coimbatore', 'Dubai', '64210');
...
(101, 49, 79, 103, 846.4, 'pending', '2020-07-13 11:04:03');
...
(126, 101, 74, 'Latest Watch', 400, 2),
(127, 101, 56, 'Asus Monitor', 20, 1);
...
(103, 'pending', 'cash_on_delivery', '2020-07-13 11:04:03', 'adssd');
...
(56, 'Asus Monitor', '<p>Asus Monitor</p>\r\n', 74, 0, 8, 20, -68, 1, 1, 'uploads/asus.jpg', 1),
...
(74, 'Latest Watch', '<p>Latest Watch</p>\r\n', 73, 28, 8, 400, 2, 1, 1, 'uploads/women_watch.jpg', 1);
...
(79, 49, 'Sankar', 'admin@admin.com', '', '9876543210', 'kinathukadavu', 'coimbatore', 'Dubai', '64210', '');
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$jC5vMlVtrPNSZNZr4cpJ.O4x.pvMMhRMkLV/NuOthbiVlttTHmsTi', 1, 1),
(18, 'Author', 'author@gmail.com', '$2y$10$jKETIxoCHl1kGQReX1FKqOdrrLtcY3jj2ykombJCSl6Uy2agVprEG', 3, 1),
(16, 'Editor', 'editor@gmail.com', '$2y$10$bkEppx0/nsiUankG/2NQ3.MKtPvhhrq46ccYHZnLSwJxwxj6GM80a', 4, 1),
(17, 'Moderator', 'moderator@gmail.com', '$2y$10$1XLPQuu0l71/s3KRqf1RCOKhc39LptCulBHqi05Mnfk1OdNd99wPi', 2, 1);
...
--
ALTER TABLE `tbl_order_details`
  MODIFY `order_details_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;
